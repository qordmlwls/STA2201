...
posterior <- fit2 |>
  ...
  mutate(estimate_nhs = alpha + iq_adjustment * beta[2], # Estimate for mothers without high school
         estimate_hs = alpha + iq_adjustment * beta[2] + beta[1]) |>  # Estimate for mothers with high school
